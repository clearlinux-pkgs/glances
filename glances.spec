...
Source0  : https://github.com/nicolargo/glances/archive/v3.2.5/glances-3.2.5.tar.gz
...
%prep
%setup -q -n glances-3.2.5
cd %{_builddir}/glances-3.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650421726
...
cp %{_builddir}/glances-3.2.5/COPYING %{buildroot}/usr/share/package-licenses/glances/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
