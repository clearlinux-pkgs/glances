...
%prep
%setup -q -n glances-3.2.3.1
cd %{_builddir}/glances-3.2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629741520
...
cp %{_builddir}/glances-3.2.3.1/COPYING %{buildroot}/usr/share/package-licenses/glances/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
