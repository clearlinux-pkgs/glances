...
Version  : 3.3.0.4
Release  : 52
URL      : https://github.com/nicolargo/glances/archive/v3.3.0.4/glances-3.3.0.4.tar.gz
Source0  : https://github.com/nicolargo/glances/archive/v3.3.0.4/glances-3.3.0.4.tar.gz
...
%prep
%setup -q -n glances-3.3.0.4
cd %{_builddir}/glances-3.3.0.4
pushd ..
cp -a glances-3.3.0.4 buildavx2
cp -a glances-3.3.0.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672174160
...
cp %{_builddir}/glances-%{version}/COPYING %{buildroot}/usr/share/package-licenses/glances/0b71159e19bef95069e18d17296291916e89b5cd
cp %{_builddir}/glances-%{version}/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/glances/0b71159e19bef95069e18d17296291916e89b5cd
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/glances/0b71159e19bef95069e18d17296291916e89b5cd
