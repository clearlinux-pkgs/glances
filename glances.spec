...
Version  : 3.3.1.1
Release  : 55
URL      : https://github.com/nicolargo/glances/archive/v3.3.1.1/glances-3.3.1.1.tar.gz
Source0  : https://github.com/nicolargo/glances/archive/v3.3.1.1/glances-3.3.1.1.tar.gz
...
%prep
%setup -q -n glances-3.3.1.1
cd %{_builddir}/glances-3.3.1.1
pushd ..
cp -a glances-3.3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697574953
