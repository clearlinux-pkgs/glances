...
Version  : 4.1.2.1
Release  : 57
URL      : https://github.com/nicolargo/glances/archive/v4.1.2.1/glances-4.1.2.1.tar.gz
Source0  : https://github.com/nicolargo/glances/archive/v4.1.2.1/glances-4.1.2.1.tar.gz
...
%prep
%setup -q -n glances-4.1.2.1
cd %{_builddir}/glances-4.1.2.1
pushd ..
cp -a glances-4.1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722355668
